          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
             ...
             >
                <span className="text-orange-500 font-bold tracking-widest text-xs uppercase mb-2 block">
                   {t('gallery_page.spotlight.subtitle')}
                </span>
                <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight whitespace-pre-line">
                   <Trans i18nKey="gallery_page.spotlight.title">
                     MAUTING SMOKEHOUSE <br/> INSTALLATION
                   </Trans>
                </h2>
                <p className="text-gray-300 text-lg mb-8 leading-relaxed">
                   {t('gallery_page.spotlight.desc')}
                </p>
                <ul className="space-y-3 mb-8 text-gray-400">
                   <li className="flex items-center gap-2"><div className="w-2 h-2 bg-orange-500 rounded-full"></div> {t('gallery_page.spotlight.point1')}</li>
                   <li className="flex items-center gap-2"><div className="w-2 h-2 bg-orange-500 rounded-full"></div> {t('gallery_page.spotlight.point2')}</li>
                </ul>
             </motion.div>
